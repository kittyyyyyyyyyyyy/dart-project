...
① 이사 임기 유연화
   ...
   핵심: 고정값 → 상한+유연결정 구조로의 변화
   ✅ 예시:
     - 변경전: "이사의 임기는 취임 후 2년 내에 종료하는 결산기에 관한 정기주주총회 종결시까지로 한다"
       변경후: "이사의 임기는 3년을 초과하지 않는 범위 내에서 주주총회에서 결정한다"
       → 고정된 임기 기준이 사라지고 '범위 내 유연 결정'이 되었으므로 ✅ 해당
     - "임기를 3년 이내로 주주총회에서 정한다" → ✅ 해당
   ❌ 비해당:
     - 단순히 "2년 → 3년"으로 숫자만 늘어난 경우는 이사 임기 유연화가 아님 (→ 이사 임기 연장)

② 이사 임기 연장
   정의: 이사 임기의 숫자 자체(연도 수)가 늘어난 경우.
   핵심: 구체적 임기 숫자의 증가 (예: 1년→2년, 2년→3년)
   ✅ 예시:
     - 변경전: "이사의 임기는 2년으로 한다"
       변경후: "이사의 임기는 3년으로 한다" → ✅ 해당
     - 변경전: "취임 후 2년 내에 종료하는..."
       변경후: "취임 후 3년 내에 종료하는..." → ✅ 해당
   ❌ 비해당:
     - 고정값이 없어지고 '범위 내 결정'으로 바뀌는 경우 → 이사 임기 유연화
   ⚠️ 동시 적용 가능:
     - 임기 숫자도 늘고, 동시에 유연화도 된 경우 → 둘 다 포함
       예) "2년" → "3년을 초과하지 않는 범위 내에서 주주총회에서 결정"
         → 이사 임기 연장(2→3) + 이사 임기 유연화(고정→유연) 모두 해당

③ 이사 정원 축소
   정의: 이사회 정원 상한이 줄어들거나, 새롭게 상한이 신설(사실상 제한)된 경우.
   핵심: 최대 인원 수의 감소 또는 무제한→유한 변경
   ✅ 예시:
     - 변경전: "이사는 3명 이상 13명 이내로 한다"
       변경후: "이사는 3명 이상 7명 이내로 한다" → ✅ 해당 (13→7)
     - 변경전: "이사는 3명 이상 16명 이내로 한다"
       변경후: "이사는 3명 이상 9인 이하로 한다" → ✅ 해당 (16→9)
   ❌ 비해당:
     - 정원 상한이 그대로거나 오히려 늘어난 경우

④ 자사주 보유
   정의: 자기주식(자사주) 보유 또는 처분에 관한 조항이 신설되거나 변경된 경우.
   핵심: "자기주식", "자사주" 등의 키워드 + 보유/처분/취득 관련 변경
   ✅ 예시:
     - 제9조의2 자기주식의 보유 또는 처분 조항 신설 → ✅ 해당
     - 자기주식 처분 방법·기준 변경 → ✅ 해당
...
예시A)
  안건제목: 정관 일부 변경
  변경전: 제9조의2(자기주식의 취득·보유·처분) [해당 조항 없음]
  변경후: 제9조의2(자기주식의 취득·보유·처분) 회사는 자기주식을 보유하거나 처분할 수 있다.
  → 결과: {{"category2": "자사주 보유"}}

예시B)
  안건제목: 이사 및 감사 관련 정관 일부 변경
  변경전: 이사는 3명 이상 13명 이내 / 이사의 임기는 2년으로 한다
  변경후: 이사는 3명 이상 7명 이내 / 이사의 임기는 3년으로 한다
  → 결과: {{"category2": "이사 정원 축소, 이사 임기 연장"}}

예시C)
  안건제목: 정관 일부 변경의 건
  변경전: 이사는 3명 이상 16명 이내 / 취임 후 2년 내에 종료하는 결산기에 관한 정기주주총회 종결시까지
  변경후: 이사는 3명 이상 9인 이하 / 3년을 초과하지 않는 범위 내에서 주주총회에서 결정한다
  → 결과: {{"category2": "이사 정원 축소, 이사 임기 연장, 이사 임기 유연화"}}
